...
public class CommentsInfo {
    ...
    public
    void setCan_post(boolean can_post) {
        this.can_post = can_post;
    }

    public
    boolean isGroups_can_post() {
        return groups_can_post;
    }

    public
    void setGroups_can_post(boolean groups_can_post) {
    ...
    public
    void setCan_close(boolean can_close) {
    ...
    public
    void setCan_open(boolean can_open) {
